...
import './Delivery.css'
import yandex from '../../assets/yandex-logo.png'
const Delivery = () => {
  return (
          ...
          <div className="info-card">
            ...
            <div className="info-card-content">
              ...
              <p className="info-card-text">
                Мы передадим ваш заказ водителю Яндекс Go. Доставка
                осуществляется в кратчайшие сроки после подтверждения.
              </p>
              <div className="price-details">
                <div className="price-item">
                  <span className="price-label">По Владивостоку </span>
          ...
          <div className="info-card">
            <div className="info-card-icon self-pickup">
              <svg viewBox="0 0 24 24">
                <path d="M12,2a8,8,0,0,0-8,8c0,5.4,7,11.5,7.35,11.86a1,1,0,0,0,1.3,0C13,21.5,20,15.4,20,10A8,8,0,0,0,12,2Zm0,11a3,3,0,1,1,3-3A3,3,0,0,1,12,13Z" />
              </svg>
            </div>
            <div className="info-card-content">
              ...
              <p className="info-card-text">
                ...
                выдачи. Мы свяжемся с вами, когда заказ будет готов к выдаче.
              </p>
              <div className="price-details">
                <div className="price-item">
