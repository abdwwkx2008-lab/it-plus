...
import qr from '../../assets/qr-mbank.jpg'
import './Payment.css'

const Payment = () => {
  const [copyButtonText, setCopyButtonText] = useState('Копировать')
  const phoneNumber = '+7 951 003 0332'
          ...
          <div className="steps-container">
            <div className="step-item">
              ...
              <div className="step-text-content">
                ...
                <p className="step-description">
                  Запустите Тинькофф или приложение другого банка на вашем
                  телефоне.
                </p>
              </div>
            </div>
            <div className="step-item">
              ...
              <div className="step-text-content">
                ...
                <p className="step-description">
                  Перейдите в раздел "Оплата по QR" или "Сканировать QR-код".
                </p>
              </div>
            </div>
            <div className="step-item">
              ...
              <div className="step-text-content">
                ...
                <p className="step-description">
                  Наведите камеру на QR-код, который вы видите на этой странице
                  справа.
                </p>
              </div>
            </div>
            <div className="step-item">
              ...
              <div className="step-text-content">
                ...
                <p className="step-description">
                  Введите сумму вашего заказа и подтвердите платеж. Готово!
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="payment-details-column">
          <div className="payment-details-card">
            ...
            <div className="recipient-info-block">
              ...
              <p className="recipient-name">Зиёхиддин.К</p>
            </div>
